...
export const getDataPromise = (localeString) => {
  ...
  /*fetch(`https://aerisweather1.p.rapidapi.com/observations/paris,fr`, {
    'method': 'GET',
    'headers': {
      'x-rapidapi-ua': 'RapidAPI-Playground',
      'x-rapidapi-key': '732eeb2fbcmsh95fa2800d19deefp12cce6jsndc9a1e410d37',
      'x-rapidapi-host': 'https://aerisweather1.p.rapidapi.com',
    },
  })
